...
Together, these three datasets provide a comprehensive 12-year record linking Victoria’s electricity demand, meteorological variability, and rooftop solar adoption — forming the foundation for the exploratory analysis and modeling that follow. \## Data Processing and Quality Checks
...
Model accuracy was evaluated using RMSE, MAE, MAPE, and R² on the held-out test set. This generalized procedure provides a robust, interpretable, and data-driven foundation for forecasting electricity demand under evolving climatic and behavioral conditions.
